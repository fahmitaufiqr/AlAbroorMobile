...
/**
 * Created by Aulia Ikvanda on 16,June,2019
 */
...
import com.example.alabroormobile.model.PengajianModel;
...
public class KegiatanActivity extends AppCompatActivity {
    ...
    KegiatanAdapter pengajianAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pengajianAdapter = new KegiatanAdapter(this, pengajianList, mPengajianId, emptyView,
                new KegiatanAdapter.ClickHandler() {
                    @Override
                    public void onItemClick(int position) {
                        ...
                        Toast.makeText(KegiatanActivity.this, "Tahan untuk edit", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public boolean onItemLongClick(int position) {
                        ...
                        pengajianAdapter.toggleSelection(mPengajianId.get(position));
                        mActionMode = KegiatanActivity.this.startSupportActionMode(mActionModeCallback);
                        return true;
                    }
                });
...
//        DATE and TIME
        ...
        viewDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(KegiatanActivity.this,
        ...
        viewTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(KegiatanActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
...
//        ===========================================================================================================================
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(KegiatanActivity.this);
...
//                        getDateandTime();
                        ...
                        Toast.makeText(KegiatanActivity.this, "Berhasil di Simpan", Toast.LENGTH_SHORT).show();
                    }
                })
        ...
        builder.setTitle(R.string.pengajian_edit)
                ...
                .setPositiveButton(R.string.pengajian_save, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mActionMode.finish();
                        Toast.makeText(KegiatanActivity.this, "Berhasil di Edit", Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mActionMode.finish();
                        Toast.makeText(KegiatanActivity.this, "Berhasil Di Hapus", Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
