...
public class PengurusDKMActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengurus_dkm);
        ...
        loading = ProgressDialog.show(PengurusDKMActivity.this,
                null,
                "Mengambil Data...",
                true,
                false);
        ...
        database.child("Pengurus").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerViewAdapterPengurus = new RecyclerViewAdapterPengurus(pengurusArrayList, PengurusDKMActivity.this);
        ...
        fab_tambah_pengurus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PengurusDKMActivity.this, TambahPengurusActivity.class)
                        .putExtra("id", "")
                        .putExtra("nama", "")
                        .putExtra("email", "")
                        .putExtra("status", ""));
